        ...
        <div className={styles.profileSection}>
            <div className={styles.profile}>
                <a className={styles.imgBox} href="#">
                    <img src='/assets/img/defaultImage.jpg' alt="Customer profile image"/>
                </a>
                <h2>닉네임</h2>
                <p>아이디</p>
                <ul className={styles.nav}>
                    <li className={styles.navItem}><a className={styles.navLink} href="/customer/mypage">마이페이지</a></li>
                    <li className={styles.navItem}><a className={styles.navLink} href="/customer/mypage-edit">개인정보수정</a>
                    </li>
                </ul>
